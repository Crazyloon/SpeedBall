...
GOLD_PER_TICK = 50                     -- How much gold should players get per tick?
GOLD_TICK_TIME = 10                     -- How long should we wait in seconds between gold ticks?

RECOMMENDED_BUILDS_DISABLED = false     -- Should we disable the recommened builds for heroes (Note: this is not working currently I believe)
CAMERA_DISTANCE_OVERRIDE = 1900.0        -- How far out should we allow the camera to go?  1134 is the default in Dota
...
if GameMode == nil then
	print ( '[BAREBONES] creating barebones game mode barebones.lua' )
	GameMode = class({})
end
...
function GameMode:InitGameMode()
	GameMode = self
	print('[BAREBONES] Starting to load Barebones gamemode... barebones.lua')
	...
	print('[BAREBONES] GameRules set barebones.lua')
	...
	print('[BAREBONES] Done loading Barebones gamemode! barebones.lua\n\n')
end
...
function GameMode:PlayerConnect(keys)
	print('[BAREBONES] PlayerConnect barebones.lua')
	DeepPrintTable(keys)
...
function GameMode:OnConnectFull(keys)
	print ('[BAREBONES] OnConnectFull barebones.lua')
	DeepPrintTable(keys)
...
function GameMode:OnGameInProgress()
	print("[BAREBONES] The game has officially begun in barebones.lua")
